  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
      ...
      <div className="lg:col-span-7 space-y-8 relative">
        ...
        <div className="absolute left-[23px] top-4 bottom-4 w-[2px] bg-gradient-to-b from-cyan-500 via-purple-500 to-transparent opacity-20 hidden md:block" />
        ...
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <div className="hidden md:flex items-center justify-center w-12 h-12 rounded-full border border-zinc-800 bg-zinc-950 z-10 transition-all duration-300 group-hover:border-cyan-400 group-hover:shadow-[0_0_15px_rgba(6,182,212,0.3)] shrink-0">
              <Briefcase className="w-5 h-5 text-zinc-400 group-hover:text-cyan-400 transition-colors" />
            </div>

            {/* Event Details Card */}
            <div className="flex-1 p-6 rounded-2xl glass-panel border border-white/10 group-hover:border-white/20 transition-all duration-300 relative overflow-hidden bg-white/[0.03]">
              {/* Background accent glow */}
              <div className="absolute -right-24 -top-24 w-48 h-48 rounded-full bg-cyan-500/5 blur-3xl group-hover:bg-cyan-500/10 transition-all duration-500 pointer-events-none" />

              <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-white/5">
                <div>
                  <h4 className="font-display font-semibold text-lg text-white group-hover:text-cyan-300 transition-colors">
                    {exp.role}
                  </h4>
      ...
      <div className="lg:col-span-5 flex flex-col gap-6 items-center justify-center">
        ...
        <motion.div
          ...
          className="relative w-full max-w-[420px] aspect-[4/3] rounded-2xl overflow-hidden box-glow-cyan p-1 group scan-line"
        >
          ...
          <div className="relative w-full h-full rounded-2xl overflow-hidden bg-zinc-950">
            ...
            <div className="absolute top-4 left-4 w-4 h-4 border-t-2 border-l-2 border-cyan-400 opacity-60 group-hover:opacity-100 transition-opacity" />
            <div className="absolute top-4 right-4 w-4 h-4 border-t-2 border-r-2 border-cyan-400 opacity-60 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="absolute bottom-4 left-4 right-4 p-2.5 rounded-lg glass-panel border border-white/10 text-center bg-zinc-950/80">
              <span className="font-mono text-[9px] tracking-widest text-cyan-400 uppercase font-bold block mb-0.5">
                Operational Setup
              </span>
        ...
        >
          ...
          <div className="relative w-full h-full rounded-2xl overflow-hidden bg-zinc-950">
            ...
            <div className="absolute bottom-4 left-4 w-4 h-4 border-b-2 border-l-2 border-cyan-400 opacity-60 group-hover:opacity-100 transition-opacity" />
            <div className="absolute bottom-4 right-4 w-4 h-4 border-b-2 border-r-2 border-cyan-400 opacity-60 group-hover:opacity-100 transition-opacity" />
